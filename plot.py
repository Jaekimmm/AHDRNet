...
parser.add_argument('--model', default='AHDR')
args = parser.parse_args()

# CSV 파일 읽기 (첫 번째 행이 헤더라면 skiprows=1)
file_path = './trained-model-' + args.model + '/plot_data.txt' 
...
plt.savefig(f"./trained-model-{args.model}/curve_loss.png", dpi=300, bbox_inches="tight")  # 고해상도 저장
...
plt.savefig(f"./trained-model-{args.model}/curve_psnr.png", dpi=300, bbox_inches="tight")  # 고해상도 저장
