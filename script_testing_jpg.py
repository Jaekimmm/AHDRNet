...
testimage_dataset = torch.utils.data.DataLoader(
    testimage_dataloader(args.test_whole_Image, patch_div=8, color=args.format, offset=args.offset),
    batch_size=1)
valid_loaders = torch.utils.data.DataLoader(
    data_loader(args.test_whole_Image, patch_div=8, color=args.format, offset=args.offset),
